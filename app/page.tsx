...
import {
  ...
  ArrowRight, Zap, Eye, PenTool, Play
} from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="border-b border-border/50 px-6 py-4 flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button variant="ghost" size="sm" onClick={() => router.push("/auth")}>Log in</Button>
      ...
      <section className="pt-24 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            <Button size="lg" className="glow-primary px-8" onClick={() => router.push("/auth")}>
      ...
      <footer className="border-t border-border px-6 py-8">
        <div className="max-w-5xl mx-auto flex items-center justify-between text-xs text-muted-foreground">
          <div className="flex items-center gap-2">
            <Image src="/scope_logo.png" alt="Scope" width={20} height={20} className="rounded" />
            <span>Scope</span>
          </div>
          <span>&copy; 2026 Scope. All rights reserved.</span>
        </div>
      </footer>
    </div>
  );
